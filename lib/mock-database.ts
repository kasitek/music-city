    ...
    const sampleUsers: User[] = [
      {
        ...
        bio: "Afrobeat artist from Lagos, Nigeria. Spreading African rhythms worldwide.",
        location: "Lagos, Nigeria",
        genres: ["Afrobeat", "Afro-fusion"],
      ...
      },
      {
        ...
        bio: "Afro-fusion producer and songwriter creating the sounds of tomorrow.",
      ...
      },
      {
        ...
        bio: "Music lover and supporter of African artists.",
        location: "London, UK",
        genres: ["Afrobeat", "R&B", "World Music"],
    ...
    const sampleTracks: Track[] = [
      {
        ...
        artistId: "user_1",
        artistName: "Kemi Adebayo",
        genre: "Afrobeat",
        duration: "3:45",
        streams: 12500,
        earnings: 125.5,
        uploadDate: "2024-01-10",
        description: "A vibrant celebration of African rhythms and modern sounds.",
      ...
      },
      {
        ...
        title: "Lagos Nights",
        artistId: "user_2",
        artistName: "Tunde Okafor",
        genre: "Afro-fusion",
        duration: "4:12",
        streams: 8200,
        earnings: 82.0,
        uploadDate: "2024-01-05",
        description: "Smooth Afro-fusion vibes inspired by the energy of Lagos nightlife.",
        coverImage: "/placeholder.svg?height=300&width=300",
        audioFile: "/placeholder-audio.mp3",
        price: 0.08,
      },
      {
        ...
        description: "Soulful R&B with African influences.",
        coverImage: "/placeholder.svg?height=300&width=300",
        audioFile: "/placeholder-audio.mp3",
        price: 0.12,
      },
    ...
    const sampleTransactions: Transaction[] = [
      {
        ...
        trackId: "track_1",
        date: "2024-01-15",
        description: "Stream earnings for Afrobeat Dreams",
      },
      {
        id: "tx_2",
        userId: "user_2",
        ...
        trackId: "track_2",
        date: "2024-01-14",
        description: "Stream earnings for Lagos Nights",
      },
      {
        id: "tx_3",
        userId: "user_1",
